...
VALUES (1, 'Bruce Lee', 95, 100, 18, 1),
       (2, 'Muhammad Ali', 85, 100, 16, 2),
       (3, 'Mike Tyson', 98, 100, 19, 2),
       (4, 'Georges St-Pierre', 85, 100, 16, 3),
       (5, 'Khabib Nurmagomedov', 93, 100, 17, 4),
       (6, 'Conor McGregor', 88, 100, 15, 5),
       (7, 'Anderson Silva', 89, 100, 16, 6),
       (8, 'Jon Jones', 96, 100, 10, 7),
       (9, 'Fedor Emelianenko', 94, 100, 17, 1),
       (10, 'Chuck Liddell', 87, 100, 14, 2);
